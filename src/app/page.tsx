  ...
  return (
    <div className='flex flex-col h-screen '>
      ...
      <div className='flex xl:flex-row flex-col flex-grow justify-center items-center w-full h-screen text-white'>
        <div className='xl:w-6/12 w-full bg-[#1C092A] h-screen flex  flex-col flex-grow items-center justify-center wallet-bg'>
          <Image src={BgImage} alt='flower' width={400} height={400} />

          <div className='w-3/12 ml-8 flex items-center justify-center'>
                <DefaultButton
                  addClass='w-6/12'
